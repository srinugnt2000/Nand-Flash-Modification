...
/***Buzzzzzzzzzz*/
      	...
      	tps6507x_pmic_modify_bits(tps, TPS6507X_REG_WLED_CTRL1, 0xFF, 0x90);
//Buzzz On 21/01/2012       	tps6507x_pmic_modify_bits(tps, TPS6507X_REG_WLED_CTRL2, 0xFF, 0x63);
       	tps6507x_pmic_modify_bits(tps, TPS6507X_REG_WLED_CTRL2, 0xFF, 0x32);	//set the pwm as 50% 
	
	printk("%s: Innolux wLED signal Enabled"
...
{
	struct tps_pmic *tps = platform_get_drvdata(pdev);
	int i;
