...
//	printk(KERN_ERR "ppp_async = ppp_asynctty_open");	//Buzzzzzzzzzzzzzzzzzzzzzz
...
//	printk(KERN_ERR "ppp_async = ppp_asynctty_close");	//Buzzzzzzzzzzzzzzzzzzzzzz
...
{
//	printk(KERN_ERR "ppp_async = ppp_asynctty_read");	//Buzzzzzzzzzzzzzzzzzzzzzz
	return -EAGAIN;
}
...
{
//	printk(KERN_ERR "ppp_async = ppp_asynctty_write");	//Buzzzzzzzzzzzzzzzzzzzzzz
	return -EAGAIN;
}
...
//	printk(KERN_ERR "ppp_async = ppp_asynctty_receive");	//Buzzzzzzzzzzzzzzzzzzzzzz
...
//	printk(KERN_ERR "ppp_async = ppp_async_process");	//Buzzzzzzzzzzzzzzzzzzzzzz
...
//	printk(KERN_ERR "ppp_async = ppp_async_send");	//Buzzzzzzzzzzzzzzzzzzzzzz
...
//	printk(KERN_ERR "ppp_async = process_input_packet");	//Buzzzzzzzzzzzzzzzzzzzzzz
...
//	printk(KERN_ERR "ppp_async = ppp_async_input");	//Buzzzzzzzzzzzzzzzzzzzzzz
